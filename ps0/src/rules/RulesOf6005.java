...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	 ...
    	 // Check if you wrote the code yourself or it's a team project with proper citation
        if (writtenByYourself || (availableToOthers && citingYourSource)) {
            // You are allowed to use your own code or code with proper citation
            return true;
        } else if (implementationRequired && writtenAsCourseWork) {
            // If it's required for the assignment and written as course work, it can be used
            return true;
        }

        // If none of the above conditions match, you may not use the code
        return false;
    }
